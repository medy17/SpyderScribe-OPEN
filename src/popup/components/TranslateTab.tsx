        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
                ...
                <Select value={sourceLang} onValueChange={setSourceLang}>
                    ...
                    <SelectContent className="bg-[#18181b] border-violet-500 text-white rounded-[10px] shadow-2xl">
                        {LANGUAGES.map(lang => (
                            <SelectItem
                                key={lang.value}
                                value={lang.value}
                                className="focus:bg-[#27272a] focus:text-white data-[state=checked]:bg-violet-500/10 data-[state=checked]:text-violet-400"
                            >
                                {lang.label}
                            </SelectItem>
                        ))}
