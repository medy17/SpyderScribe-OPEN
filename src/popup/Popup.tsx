            ...
            <header className="flex items-center justify-center gap-3 mb-5">
                ...
                <div className="flex flex-col items-start leading-tight">
                    ...
                    <div className="flex items-center gap-1.5">
                        <div className="w-1 h-1 rounded-full bg-[#f38bae]"></div>
                        <span className="text-[#f38bae] font-medium text-xs tracking-wide uppercase">Community Edition</span>
                    </div>
                </div>
            </header>
